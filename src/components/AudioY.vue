    ...
    <div class="item-detail-show">
      <div class="item-detail-left">
        <div class="item-detail-big-img">
          <img :src="goodsInfoAudioY.goodsImg[imgIndex]" alt="" />
        </div>
        ...
        <div class="item-select">
          ...
          <div class="item-select-column">
            <div
              ...
              v-for="(items, index) in goodsInfoAudioY.setMeal"
              :key="index"
            >
              <div
...
export default {
  ...
  computed: {
    ...mapState(["goodsInfoAudioY"]),
    ...mapGetters(["cookies"]),
  },
  methods: {
    ...mapActions(["addShoppingCart", "loadGoodsInfoAudioY"]),
  ...
  mounted() {
    const father = this;
    setTimeout(() => {
      father.price = father.goodsInfoAudioY.setMeal[0][0].price || 0;
    }, 300);
    var arr,
