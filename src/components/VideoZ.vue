    ...
    <div class="item-detail-show">
      <div class="item-detail-left">
        <div class="item-detail-big-img">
          <img :src="goodsInfoVideoZ.goodsImg[imgIndex]" alt="" />
        </div>
        ...
        <div class="item-select">
          ...
          <div class="item-select-column">
            <div
              ...
              v-for="(items, index) in goodsInfoVideoZ.setMeal"
              :key="index"
            >
              <div
...
export default {
  ...
  methods: {
    ...mapActions(["addShoppingCart","loadGoodsInfoVideoZ"]),
  ...
  mounted() {
    const father = this;
    setTimeout(() => {
      father.price = father.goodsInfoVideoZ.setMeal[0][0].price || 0;
    }, 300);
    var arr,
